...
* #313: Modified `export_to_callback` and `import_from_callback` to raise an exception
that combines any caught exception with any experienced in the HTTP or SQL threads
