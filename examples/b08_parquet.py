...
C.export_to_parquet(dst=filepath, query_or_table="users")
...
# import_from_parquet allows for other ways to specify this information
filepath_glob = f"{filepath}/*.parquet"
...
parquet_table = pq.read_table(f"{filepath}/{basename_template.format(i=0)}")
print(parquet_table.schema)
