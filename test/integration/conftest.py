...
@pytest.fixture(scope="session")
def dsn_resolved(default_ipaddr, default_port):
...
@pytest.fixture(scope="session")
def dsn(certificate_type, default_ipaddr, default_port):
    ...
    return os.environ.get("EXAHOST", f"exasol-test-database:{default_port}")
